...
class AdvancedGunBehaviour : MonoBehaviour, IGunInheritable
{
   ...
   //     {
   //   new MultiActiveReloadData(activeReloadStartPercentage, startValue, endValue, markerPixelWidth, markerPixelWidth* 3, stopsReload, canAttemptActiveReloadAfterwards, new ActiveReloadData
   //     {
   //     damageMultiply = yourDamageMultiplier,
   //}, true)
   //};
   //}
