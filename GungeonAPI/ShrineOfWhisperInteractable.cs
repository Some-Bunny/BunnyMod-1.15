...
namespace GungeonAPI
{
	...
	public class WhisperShrineInteractible : SimpleInteractable, IPlayerInteractable
	{
		...
		private IEnumerator HandleConversation(PlayerController interactor)
		{
			...
			if (flag2)
			{
				...
				TextBoxManager.ShowTextBox(this.talkPoint.position, this.talkPoint, 1f, "You embrace the Challenge Of The Whisper.", interactor.characterAudioSpeechTag, false, TextBoxManager.BoxSlideOrientation.NO_ADJUSTMENT, false, false);
