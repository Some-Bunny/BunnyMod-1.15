...
namespace BunnyMod
{
	...
	public class JammedSquireInteractable : SimpleInteractable, IPlayerInteractable
	{
		...
		private IEnumerator HandleConversation(PlayerController interactor)
		{
			...
			yield return null;
			List<string> conversationToUse = JammedSquire.NoHarderLotJ ? this.conversation : this.conversationB;
			int num;
			...
			string acceptanceTextToUse = JammedSquire.NoHarderLotJ ? this.acceptText : this.acceptTextB;
			string declineTextToUse = JammedSquire.NoHarderLotJ ? this.declineText : this.declineTextB;
