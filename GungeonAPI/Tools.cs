...
namespace GungeonAPI
{
	...
	public static class Tools
	{
		...
		public static void Init()
		{
			...
			Tools.shared_auto_001 = assetBundle;
			Tools.shared_auto_002 = assetBundle2;
		...
		public static DungeonFlowNode GenerateFlowNode(DungeonFlow flow, PrototypeDungeonRoom.RoomCategory category, PrototypeDungeonRoom overrideRoom = null, GenericRoomTable overrideRoomTable = null, bool loopTargetIsOneWay = false, bool isWarpWing = false, bool handlesOwnWarping = true, float weight = 1f, DungeonFlowNode.NodePriority priority = DungeonFlowNode.NodePriority.MANDATORY, string guid = "")
		{
			...
			return new DungeonFlowNode(flow)
			{
		...
		{
			// Token: 0x060007C1 RID: 1985 RVA: 0x00050BEE File Offset: 0x0004EDEE
			public CustomBulletScriptSelector(Type _bulletType)
			{
				this.bulletType = _bulletType;
				this.scriptTypeName = this.bulletType.AssemblyQualifiedName;
			}

			// Token: 0x060007C2 RID: 1986 RVA: 0x00050C10 File Offset: 0x0004EE10
			public new Bullet CreateInstance()
			{
				bool flag = this.bulletType == null;
				Bullet result;
				if (flag)
				{
					ETGModConsole.Log("Unknown type! " + this.scriptTypeName, false);
					result = null;
				}
				else
				{
					result = (Bullet)Activator.CreateInstance(this.bulletType);
				}
				return result;
			}

			// Token: 0x17000085 RID: 133
			// (get) Token: 0x060007C3 RID: 1987 RVA: 0x00050C5C File Offset: 0x0004EE5C
			...
			// Token: 0x060007C4 RID: 1988 RVA: 0x00050C90 File Offset: 0x0004EE90
			public new BulletScriptSelector Clone()
			{
				return new Tools.CustomBulletScriptSelector(this.bulletType);
			}
		...
		private static string defaultLog = Path.Combine(ETGMod.ResourcesDirectory, "why.txt");
