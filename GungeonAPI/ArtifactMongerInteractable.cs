...
namespace BunnyMod
{
	...
	public class ArtifactMongerInteractable : SimpleInteractable, IPlayerInteractable
	{
		...
		public void Interact(PlayerController interactor)
		{
			...
			if (flag2)
			{
				...
				if (flag4)
				{
					...
					TextBoxManager.ShowTextBox(this.talkPoint.position, this.talkPoint, 2f, ":DDDDDD", interactor.characterAudioSpeechTag, false, TextBoxManager.BoxSlideOrientation.NO_ADJUSTMENT, false, false);
				}
				else
				{
		...
		private IEnumerator HandleConversation(PlayerController interactor)
		{
			...
			yield return null;
			List<string> conversationToUse = !ArtifactMonger.RandomArtifactMode ? this.conversation : this.conversationB;
			int num;
			...
			string acceptanceTextToUse = !ArtifactMonger.RandomArtifactMode ? this.acceptText : this.acceptTextB;
			string declineTextToUse = !ArtifactMonger.RandomArtifactMode ? this.declineText : this.declineTextB;
			...
			if (flag)
			{
				...
				TextBoxManager.ShowTextBox(this.talkPoint.position, this.talkPoint, 1f, "YEYYYY!", interactor.characterAudioSpeechTag, false, TextBoxManager.BoxSlideOrientation.NO_ADJUSTMENT, false, false);
