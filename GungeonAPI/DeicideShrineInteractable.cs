...
namespace BunnyMod
{
	...
	public class DeicideShrineInteractible : SimpleInteractable, IPlayerInteractable
	{
		...
		private IEnumerator HandleConversation(PlayerController interactor)
		{
			...
			yield return null;
			List<string> conversationToUse = !DeicideShrine.AllArtifactMode ? this.conversation : this.conversationB;
			int num;
			...
			string acceptanceTextToUse = !DeicideShrine.AllArtifactMode ? this.acceptText : this.acceptTextB;
			string declineTextToUse = !DeicideShrine.AllArtifactMode ? this.declineText : this.declineTextB;
