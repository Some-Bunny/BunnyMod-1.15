...
namespace BunnyMod
{
    public class AncientWhisperInfinite : PlayerItem
    {
        private float random;

        public static void Init()
        {
            string itemName = "DevAncient Whisper";
            ...
            whisper.SetCooldownType(ItemBuilder.CooldownType.Timed, 1f);
            whisper.AddPassiveStatModifier(PlayerStats.StatType.AdditionalItemCapacity, 1f, StatModifier.ModifyMethod.ADDITIVE);
