...
public class ReaveOnReloadModifier : MonoBehaviour
{
	// Token: 0x0600700B RID: 28683 RVA: 0x002B7FC9 File Offset: 0x002B61C9
	public ReaveOnReloadModifier()
	{
		this.AuraRadius = 3.25f;
		this.DamagePerSecond = 70f;
		this.RadiusSynergyRadius = 3.5f;
	}
	...
	private void HandleRadialIndicator()
	{
		if (!this.m_radialIndicatorActive)
		{
			...
			{
				this.m_radialIndicator.CurrentColor = Color.magenta.WithAlpha(30f);
